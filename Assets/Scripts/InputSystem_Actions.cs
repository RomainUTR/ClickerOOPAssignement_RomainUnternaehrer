...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Clicker"",
            ""id"": ""e0829143-224f-499a-93d0-978490f4147b"",
            ""actions"": [
                {
                    ""name"": ""Click"",
                    ""type"": ""Button"",
                    ""id"": ""10a49f79-cc55-48cd-b79d-9c3d18473df3"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Factory"",
                    ""type"": ""Button"",
                    ""id"": ""d305a947-3cc8-4c41-82fc-c003792a2020"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""ClickPower"",
                    ""type"": ""Button"",
                    ""id"": ""b6d2fcc5-f6d7-41b6-9e0f-14c0ce514f53"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a0dd6116-b89a-4a35-9dec-8cc294a5b161"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""bebb7d2b-470c-4df9-8c92-50e6264483ed"",
                    ""path"": ""<Keyboard>/b"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""e525c623-7181-4ca0-b049-17b60d58eaa8"",
                    ""path"": ""<Keyboard>/u"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
    ...
    ""controlSchemes"": [
        ...
        m_Clicker_Factory = m_Clicker.FindAction("Factory", throwIfNotFound: true);
        m_Clicker_ClickPower = m_Clicker.FindAction("ClickPower", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Clicker.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Clicker.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Clicker_Factory;
    private readonly InputAction m_Clicker_ClickPower;
    /// <summary>
    /// Provides access to input actions defined in input action map "Clicker".
    /// </summary>
    public struct ClickerActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ClickerActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Clicker/Click".
        /// </summary>
        public InputAction @Click => m_Wrapper.m_Clicker_Click;
        /// <summary>
        /// Provides access to the underlying input action "Clicker/Factory".
        /// </summary>
        public InputAction @Factory => m_Wrapper.m_Clicker_Factory;
        /// <summary>
        /// Provides access to the underlying input action "Clicker/ClickPower".
        /// </summary>
        public InputAction @ClickPower => m_Wrapper.m_Clicker_ClickPower;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="ClickerActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        public void AddCallbacks(IClickerActions instance)
        {
            ...
            @ClickPower.started += instance.OnClickPower;
            @ClickPower.performed += instance.OnClickPower;
            @ClickPower.canceled += instance.OnClickPower;
        }
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ClickerActions.UnregisterCallbacks(IClickerActions)" />.
        /// </summary>
        /// <seealso cref="ClickerActions.UnregisterCallbacks(IClickerActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="ClickerActions.AddCallbacks(IClickerActions)" />
        /// <seealso cref="ClickerActions.RemoveCallbacks(IClickerActions)" />
        /// <seealso cref="ClickerActions.UnregisterCallbacks(IClickerActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="ClickerActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Clicker" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="ClickerActions.AddCallbacks(IClickerActions)" />
    /// <seealso cref="ClickerActions.RemoveCallbacks(IClickerActions)" />
    public interface IClickerActions
    {
        ...
        void OnClick(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "Factory" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Method invoked when associated input action "ClickPower" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnClickPower(InputAction.CallbackContext context);
    }
}
